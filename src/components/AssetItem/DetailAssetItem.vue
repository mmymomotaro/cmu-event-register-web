        ...
        <v-col cols="12" md="7">
          ...
          <v-row no-gutters>
            ...
            <v-col cols="12" md="6" class="pa-1">
              <v-btn small block color="blue" class="white--text" style="height:35px;"  @click="openUpdateAssetItem(dataAsset)">แก้ไข</v-btn>
            </v-col>
            <v-col cols="12" md="6" class="pa-1">
              <v-btn small block color="red" class="white--text" style="height:35px;" @click="openDeleteAssetItem(dataAsset)">ลบ</v-btn>
            </v-col>
          </v-row>
        </v-col>
      </v-row>
